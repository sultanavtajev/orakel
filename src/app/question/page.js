...
return (
  <div className="p-4 max-w-4xl mx-auto bg-white">
    <h2 className="text-xl mb-4 text-black">Del 1: Generelle Spørsmål:</h2>
    ...
    <h2 className="text-xl mt-7 mb-4 text-black">Del 2: Jungiansk Typeindeks</h2>
    ...
    <button
      ...
      className="bg-black text-white px-4 py-2 rounded mt-4 w-full mb-7"
    >
      Få spådommen din
    </button>
  </div>
